...
import 'package:recallr/core/features/view/re_category.dart';
...
void main() {
  ...
  group('populated', () {
    ...
    goldenTest(
      'renders the populated categories screen',
      fileName: 're_category_populated',
  ...
  group('empty', () {
    ...
    goldenTest(
      'renders the empty categories screen',
      fileName: 're_category_empty',
      pumpBeforeTest: pumpForAsyncData,
      builder: () => scenarios(isar),
    );
  });
